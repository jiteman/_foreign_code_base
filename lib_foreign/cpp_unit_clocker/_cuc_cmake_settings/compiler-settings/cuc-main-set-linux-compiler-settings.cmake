...
if ( UNIX )
	...
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS "-Wno-unused-parameter" )
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS "-Wno-format-nonliteral" )
	list( APPEND ${PROJECT_NAME}_CXX_FLAGS "-Wno-missing-declarations" )
