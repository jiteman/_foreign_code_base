set( JMSD_FOREIGN_COMPONENT_NAME test-cppunit-foundation )

JMSD_CMAKE_CURRENT_FILE_IN( "${JMSD_FOREIGN_COMPONENT_NAME}-set-compiler-settings.cmake" )


if ( UNIX )
	JMSD_SHOW_BUILD_MESSAGE( "${JMSD_FOREIGN_COMPONENT_NAME} COMPILER SETTINGS: Linux linker settings are selected" )
...
elseif( WIN32 )
	JMSD_SHOW_BUILD_MESSAGE( "${JMSD_FOREIGN_COMPONENT_NAME} COMPILER SETTINGS: Windows linker settings are selected" )
